...
version-apply profile, heartbeat cadence), `cursor(id, latest, finalized, updated_at)`,
...
(`namespace:topic:orderingKey:seq`) for pipelines demanding a globally unique record id;
